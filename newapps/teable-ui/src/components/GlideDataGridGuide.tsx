...
import { DataEditor, GridCellKind, GridColumn, Item, GridCell, EditableGridCell, CompactSelection, GridSelection } from '@glideapps/glide-data-grid';
      ...
      <div className="mb-4">
        ...
        {gridSelection && (
          <div className="mb-4 p-2 bg-blue-100 rounded">
            <p className="text-sm">
              已选择单元格: {gridSelection.current ? `行 ${gridSelection.current.cell[1]}, 列 ${gridSelection.current.cell[0]}` : '无'}
            </p>
          </div>
        )}
      </div>
